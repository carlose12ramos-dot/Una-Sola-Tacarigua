    ...
    <section className={styles.container} id="cultura">
      <div className="container">
        <div className={styles.header}>
          <h2 className={styles.title}>Patrimonio Cultural</h2>
          <div className="divider" style={{ margin: '1rem auto', width: '150px' }}></div>
          <p className={styles.description}>
            Conoce a los hombres y mujeres que mantienen viva la llama de nuestras tradiciones, nuestras costumbres y nuestra rica gastronomía.
          </p>
        </div>
