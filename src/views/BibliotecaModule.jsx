...
import { Play, X, Search, BookOpen, Music, Film, Download, ExternalLink } from 'lucide-react';
...
function BibliotecaModule() {
  ...
  useEffect(() => {
    ...
    const useFallbackMock = () => {
      ...
      setItems([...fallbackBooks, ...fallbackMusic, ...fallbackVideos, ...otherMockItems]);
    };
              ...
              >
                <div className={styles.cardMedia}>
                  ...
                  <div className={styles.cardOverlay}>
                    {item.formato === 'Libros' ? (
                      <BookOpen size={28} className={styles.mediaIcon} />
                    ) : item.formato === 'Música' ? (
                      <Music size={28} className={styles.mediaIcon} />
                    ) : (
                      <Film size={28} className={styles.mediaIcon} />
                    )}
                  </div>
                </div>
                ...
                <div className={styles.cardContent}>
                  ...
                  <h3 className={styles.cardTitle}>{formatTitle(item.titulo)}</h3>
        ...
        <div className={styles.videoModalOverlay} onClick={() => setSelected(null)}>
          <div className={styles.videoModalContent} onClick={e => e.stopPropagation()}>
            ...
            <div className={styles.modalHeader}>
              <h2 className={styles.modalTitle}>{formatTitle(selected.titulo)}</h2>
      ...
      {selected && selected.formato !== 'Videos' && (
        <div className={`${styles.player} ${selected ? styles.playerVisible : ''}`}>
          ...
          <div className={styles.playerInfo}>
            <div className={styles.playerTitle}>{formatTitle(selected.titulo)}</div>
